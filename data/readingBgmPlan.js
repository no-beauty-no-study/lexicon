...
(function () {
  ...
  window.READING_BGM_PLAN = {
    ...
    // The 26 taggable categories (dotted) → track. data/paths-bgm-tags.js tags
    // each scene with one of these; Views.vn cues it as the scene is reached.
    pathsCat: {
      "main.theme":          P("00_glass_bloom_main_theme_long.mp3"),
      "common.daily":        P("01_daily_happy_sunlit_messages.mp3"),
      "common.tension":      P("02_daily_tension_before_reply.mp3"),
      ...
      "sealyra.performance": P("19_luv_poem_performance_loop.mp3"),
      "shiro.daily":         P("03_shiro_daily_silver_glass.mp3"),
      "shiro.heart":         P("04_shiro_heart_choose_me_once.mp3"),
      "shiro.sad":           P("05_shiro_sad_three_safe_houses.mp3"),
      "shiro.sweet":         P("15_shiro_love_daily_soft_static.mp3"),
      "hosea.daily":         P("06_hosea_daily_white_fox.mp3"),
      "hosea.heart":         P("07_hosea_heart_hunter_hit.mp3"),
      "hosea.sad":           P("08_hosea_sad_rues_shadow.mp3"),
      "hosea.sweet":         P("22_hosea_sweet_daily_after_school.mp3"),
      "jael.daily":          P("21_jael_daily_velvet_courtesy.mp3"),
      "jael.heart":          P("10_jael_heart_aubade_fever.mp3"),
      "jael.sad":            P("11_jael_sad_shedding_skin.mp3"),
      "jael.sweet":          P("23_jael_sweet_daily_after_hours.mp3"),
      "jael.dark":           P("09_jael_daily_gold_knife.mp3"),
      "kye.daily":           P("12_kye_ward_deer_at_dawn.mp3"),
      "kye.sad":             P("12_kye_ward_deer_at_dawn.mp3"),
      "kye.heart":           P("18_kye_deer_at_dawn_bloom.mp3"),
      "kye.bloom":           P("18_kye_deer_at_dawn_bloom.mp3"),
    },
