...
const CHAPTERS = [
  ...
  { id: "australia-pacific",   number: "05", title: "Australia & Pacific",
    ...
    firstSection: "5.1" },
  // Index/story order follows the painted Table of Contents artwork:
  // slot 06 = South America, 07 = Asia, 08 = Oceans. The content
  // sections are renumbered to match (south-america = 6.x, asia = 7.x,
  // oceans = 8.x) so "Chapter NN" and the section labels agree.
